...
pub struct TextureArrayRenderer {
    ...
    transparent_draws_to_world: Vec<DrawImage>,
        ...
        match target {
            Target::World => {
                if draw.position.z == 0.0 {
                    ...
                    self.transparent_draws_to_world.push(draw);
                } else {
...
impl TextureArrayRenderer {
    pub fn initialize(state: &State) -> Self {
        ...
        Self {
            ...
            draws_to_world: vec![],
            transparent_draws_to_world: vec![],
            draws_to_ui: vec![],
    ...
    fn prepare(
        ...
        let main_draws_len = self.draws_to_zero_world.len()
            ...
            + self.transparent_draws_to_world.len()
        ...
        self.main.update_draws(&mut self.transparent_draws_to_world);
        ...
        self.transparent_draws_to_world.clear();
